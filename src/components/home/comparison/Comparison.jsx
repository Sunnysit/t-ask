...
const Comparison = () => {
    ...
    useEffect(() => {
        ...
        ////////////////////LANGUAGES API COMPARISON FEATURE TIME BASED
        Axios
        ...
        Axios
            ...
            .then(result => {
                //COMPARISON FEATURE LOCATION BASED USA DATA
        ...
        // //////////////////JOBS API COMPARISON FEATURE TIME BASED
        // Axios.get('https://t-ask-api.herokuapp.com/api/comparison/jobs/jobcategories'
        // )    .then(result => {        const jobsArray = result.data.map(jobs => {
        //        return {languageName:jobs.name, languageId: jobs.id, isSelect: false,
        // total: jobs.totalJobs}        })        dispatch({type:})    })
